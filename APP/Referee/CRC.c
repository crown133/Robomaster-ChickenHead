...
/**
  * @brief	Get CRC8 chechsum function
  * @note	不需要直接调用
  * @param	pchMessage	Data to check
  * @param	dwLength	Stream length = Data
...
/**
  * @brief	Get CRC16 chechsum function
  * @note	不需要直接调用
  * @param	pchMessage	Data to check
  * @param	dwLength	Stream length = Data
  * @param	wCRC		Initialized checksum
...
void Append_CRC16_Check_Sum(uint8_t *pchMessage, uint32_t dwLength)
{
	...
	wCRC = Get_CRC8_Check_Sum((unsigned char *)pchMessage, dwLength - 2, CRC16_INIT);
